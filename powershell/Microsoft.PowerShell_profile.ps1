...
# C:\Users\theyk\AppData\Local\Programs\Microsoft VS Code Insiders\bin\
$insider = "C:\Users\theyk\AppData\Local\Programs\Microsoft VS Code Insiders\bin\"
...
Set-PoshPrompt -Theme  C:\Users\theyk\.maxim-theme.omp.json
...
if (Test-Path "$env:USERPROFILE\Documents\MEGAsync") {
    New-PSDrive -Name Work -PSProvider FileSystem -Root "$env:USERPROFILE\Documents\MEGAsync" -Description "Work Folders"
...
function g { Set-Location $HOME\Documents\MegaSync\ }
